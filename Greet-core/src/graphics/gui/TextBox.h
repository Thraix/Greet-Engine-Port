...
namespace Greet
{
  class TextBox : public Component
  {
    ...
    public:
      ...
      virtual void KeyPressed(KeyPressEvent& event) override;
      virtual void KeyReleased(KeyReleaseEvent& event) override;
      virtual void KeyTyped(KeyTypeEvent& event) override;
